...
export default class ModalSuaNhanHang extends Component {
  state = {
    isVisible: false, //state of modal default false
    TenNhanHang: "",
  }
  showModalSuaNhanHang = (item) => {
    this.refs.ModalSuaNhanHang.open(
      this.setState({
        TenNhanHang: item.tennhanhang
      })
    )
  }
  SuaNhanHang = () => {
    Alert.alert("sửa nhãn hàng")
  }
  render() {
    return (
      <Modal ref={"ModalSuaNhanHang"}
      ...
      >
        ...
        <Button
          ...
          onPress={() => {
            ...
            this.refs.ModalSuaNhanHang.close();
          }}>
          Sửa Nhãn Hàng
      </Button>
      </Modal>
